public final class ApiConstants {
    public static final String URI_CREATE_USER_OR_DELETE = "https://petstore.swagger.io/v2/user";
    ...
    public static final String CREATE_PET_OR_UPDATE = "https://petstore.swagger.io/v2/pet";
